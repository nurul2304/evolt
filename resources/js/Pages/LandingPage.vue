...
<template>
  <div class="min-h-screen flex flex-col bg-white font-sans">
    ...
    <main class="flex-grow relative z-10 pt-20">
      ...
      <!-- HERO SECTION -->
      <section
        class="bg-[#CCFF00] pt-10 pb-12 sm:pt-16 sm:pb-16 lg:pt-20 lg:pb-20 relative overflow-hidden rounded-b-[2.5rem] lg:rounded-none shadow-sm lg:shadow-none z-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div class="flex flex-col lg:flex-row items-center justify-between gap-8 md:gap-10 lg:gap-12">
            ...
            <div class="w-full lg:w-1/2 text-center lg:text-left order-1 lg:order-1">
              <h2
                class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-[#333] leading-tight mb-4 lg:mb-6 tracking-tight">
                Cari Charger<br>Tanpa Ribet.
              </h2>
              <p
                class="text-lg sm:text-xl lg:text-2xl text-gray-800 font-medium mb-10 max-w-md mx-auto lg:mx-0 leading-relaxed opacity-90">
                Hemat waktu perjalanan keluarga Anda. Temukan lokasi SPKLU terdekat dan tersedia hanya dalam hitungan
                detik.
              </p>
      ...
      <section class="py-12 lg:py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex justify-center">
            ...
            <!-- Sign Up CTA Card -->
            <div
              class="bg-[#00C853] p-6 sm:p-8 rounded-3xl shadow-xl text-white relative overflow-hidden flex flex-col justify-center h-full">
              ...
              <div class="relative z-10 text-center lg:text-left">
                ...
                <button
                  class="bg-white text-[#00C853] font-bold px-6 py-3.5 rounded-xl shadow-md hover:bg-gray-50 active:scale-95 transition duration-300 w-full lg:w-auto text-base">
                  Daftar Gratis
                </button>
              </div>
            </div>
